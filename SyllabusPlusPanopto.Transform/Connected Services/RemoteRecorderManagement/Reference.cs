...
namespace RemoteRecorderManagement
{
    ...
    public interface IRemoteRecorderManagement
    {
        ...
        RemoteRecorderManagement.RemoteRecorder[] GetRemoteRecordersById(RemoteRecorderManagement.AuthenticationInfo auth, System.Guid[] remoteRecorderIds);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRemoteRecorderManagement/GetRemoteRecordersByExternalId", ReplyAction="http://tempuri.org/IRemoteRecorderManagement/GetRemoteRecordersByExternalIdRespon" +
            "se")]
        RemoteRecorderManagement.RemoteRecorder[] GetRemoteRecordersByExternalId(RemoteRecorderManagement.AuthenticationInfo auth, string[] externalIds);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IRemoteRecorderManagement/UpdateRemoteRecorderExternalId", ReplyAction="http://tempuri.org/IRemoteRecorderManagement/UpdateRemoteRecorderExternalIdRespon" +
            "se")]
        void UpdateRemoteRecorderExternalId(RemoteRecorderManagement.AuthenticationInfo auth, System.Guid remoteRecorderId, string externalId);
        ...
        RemoteRecorderManagement.ListRecordersResponse ListRecorders(RemoteRecorderManagement.AuthenticationInfo auth, RemoteRecorderManagement.Pagination pagination, RemoteRecorderManagement.RecorderSortField sortBy);
        ...
        RemoteRecorderManagement.ScheduledRecordingResult ScheduleRecording(RemoteRecorderManagement.AuthenticationInfo auth, string name, System.Guid folderId, bool isBroadcast, System.DateTime start, System.DateTime end, RemoteRecorderManagement.RecorderSettings[] recorderSettings);
        ...
        RemoteRecorderManagement.ScheduledRecordingResult ScheduleRecurringRecording(RemoteRecorderManagement.AuthenticationInfo auth, System.Guid scheduledSessionId, System.DayOfWeek[] daysOfWeek, System.DateTime end);
        ...
        RemoteRecorderManagement.ScheduledRecordingResult UpdateRecordingTime(RemoteRecorderManagement.AuthenticationInfo auth, System.Guid sessionId, System.DateTime start, System.DateTime end);
        ...
        RemoteRecorderManagement.ScheduledRecordingResult UpdateRecordingSettings(RemoteRecorderManagement.AuthenticationInfo auth, System.Guid sessionId, RemoteRecorderManagement.RecorderSettings[] recorderSettings);
        ...
        System.Guid GetDefaultFolderForRecorder(RemoteRecorderManagement.AuthenticationInfo auth, System.Guid remoteRecorderId);
        ...
        string GetMachineSidForRecorder(RemoteRecorderManagement.AuthenticationInfo auth, System.Guid remoteRecorderId);
    }
    ...
    public partial class RemoteRecorderManagementClient : System.ServiceModel.ClientBase<RemoteRecorderManagement.IRemoteRecorderManagement>, RemoteRecorderManagement.IRemoteRecorderManagement
    {
        ...
        public RemoteRecorderManagement.RemoteRecorder[] GetRemoteRecordersById(RemoteRecorderManagement.AuthenticationInfo auth, System.Guid[] remoteRecorderIds)
        {
            return base.Channel.GetRemoteRecordersById(auth, remoteRecorderIds);
        }
        
        public RemoteRecorderManagement.RemoteRecorder[] GetRemoteRecordersByExternalId(RemoteRecorderManagement.AuthenticationInfo auth, string[] externalIds)
        {
            return base.Channel.GetRemoteRecordersByExternalId(auth, externalIds);
        }
        
        public void UpdateRemoteRecorderExternalId(RemoteRecorderManagement.AuthenticationInfo auth, System.Guid remoteRecorderId, string externalId)
        {
            base.Channel.UpdateRemoteRecorderExternalId(auth, remoteRecorderId, externalId);
        }
        
        public RemoteRecorderManagement.ListRecordersResponse ListRecorders(RemoteRecorderManagement.AuthenticationInfo auth, RemoteRecorderManagement.Pagination pagination, RemoteRecorderManagement.RecorderSortField sortBy)
        {
            return base.Channel.ListRecorders(auth, pagination, sortBy);
        }
        
        public RemoteRecorderManagement.ScheduledRecordingResult ScheduleRecording(RemoteRecorderManagement.AuthenticationInfo auth, string name, System.Guid folderId, bool isBroadcast, System.DateTime start, System.DateTime end, RemoteRecorderManagement.RecorderSettings[] recorderSettings)
        {
            return base.Channel.ScheduleRecording(auth, name, folderId, isBroadcast, start, end, recorderSettings);
        }
        
        public RemoteRecorderManagement.ScheduledRecordingResult ScheduleRecurringRecording(RemoteRecorderManagement.AuthenticationInfo auth, System.Guid scheduledSessionId, System.DayOfWeek[] daysOfWeek, System.DateTime end)
        {
            return base.Channel.ScheduleRecurringRecording(auth, scheduledSessionId, daysOfWeek, end);
        }
        
        public RemoteRecorderManagement.ScheduledRecordingResult UpdateRecordingTime(RemoteRecorderManagement.AuthenticationInfo auth, System.Guid sessionId, System.DateTime start, System.DateTime end)
        {
            return base.Channel.UpdateRecordingTime(auth, sessionId, start, end);
        }
        
        public RemoteRecorderManagement.ScheduledRecordingResult UpdateRecordingSettings(RemoteRecorderManagement.AuthenticationInfo auth, System.Guid sessionId, RemoteRecorderManagement.RecorderSettings[] recorderSettings)
        {
            return base.Channel.UpdateRecordingSettings(auth, sessionId, recorderSettings);
        }
        
        public System.Guid GetDefaultFolderForRecorder(RemoteRecorderManagement.AuthenticationInfo auth, System.Guid remoteRecorderId)
        {
            return base.Channel.GetDefaultFolderForRecorder(auth, remoteRecorderId);
        }
        
        public string GetMachineSidForRecorder(RemoteRecorderManagement.AuthenticationInfo auth, System.Guid remoteRecorderId)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IRemoteRecorderManagement))
            {
                return new System.ServiceModel.EndpointAddress("https://leedstest.cloud.panopto.eu/Panopto/PublicAPI/4.2/RemoteRecorderManagement" +
                        ".svc");
            }
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IRemoteRecorderManagement1))
            {
                return new System.ServiceModel.EndpointAddress("http://leedstest.cloud.panopto.eu/Panopto/PublicAPI/4.2/RemoteRecorderManagement." +
                        "svc");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
